...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
                  <img src="images/small_mess.jpg" class="d-block w-100" alt="image">
    ...
    <div class="carousel-item">
               <img src="images/droppedImage.jpg" class="d-block w-100" alt="image">
            <div class="carousel-caption d-none d-md-block">
                <h5>IITG Mess Feedback System</h5>
                <p>The one stop solution to Mess Reports, Feedback, Change Mess and Admin support</p>
              </div>
    ...
    <div class="carousel-item">
               <img src="images/IIT-guwahati.jpg" class="d-block w-100" alt="image">
            <div class="carousel-caption d-none d-md-block">
                <h5>IITG Mess Feedback System</h5>
                <p>The one stop solution to Mess Reports, Feedback, Change Mess and Admin support</p>
              </div>
    ...
    <div class="carousel-item">
               <img src="images/06.jpg" class="d-block w-100" alt="image">
            <div class="carousel-caption d-none d-md-block">
                <h5>IITG Mess Feedback System</h5>
                <p>The one stop solution to Mess Reports, Feedback, Change Mess and Admin support</p>
              </div>
